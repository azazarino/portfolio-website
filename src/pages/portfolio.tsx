    ...
    <Element name="home-element">
      <section id='home-section'>
        <div className='profile-div'>
          <img src="/assets/CV_photo.jpg" alt="profile-picture" />
        </div>
        <div className='intro-text'>
          <h1>Azer Omar</h1>
          <p>Computer Engineer & MSc Computer Science Student</p>
          <p>Artificial Intelligence & Machine Learning • Embedded Systems • Web Development • Cybersecurity</p>
